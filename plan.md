...
| Дата       | Тема                                      | Описание                                                                       |
+------------|-------------------------------------------|--------------------------------------------------------------------------------+
| 14.11.2025 | Event Sourcing и CQRS                     | Паттерны для DDD: события как источник истины, разделение чтения/записи        |
| 16.11.2025 | Redis: полное руководство                 | Типы данных, команды, паттерны кэширования, pub/sub, транзакции, кластеризация |
| 17.11.2025 | MongoDB: документоориентированные БД      | CRUD, агрегации, индексы, репликация, шардирование                             |
| 18.11.2025 | Elasticsearch: полнотекстовый поиск       | Индексы, анализаторы, query DSL, агрегации                                     |
| 19.11.2025 | Apache Kafka: потоковая обработка         | Топики, партиции, консьюмеры, продюсеры, Kafka Streams                         |
| 20.11.2025 | gRPC vs REST: выбор API                   | Протоколы, производительность, когда что использовать                          |
| 21.11.2025 | GraphQL: альтернатива REST                | Схемы, резолверы, фрагменты, подписки                                          |
| 22.11.2025 | WebSocket: real-time приложения           | Протокол, handshake, комнаты, масштабирование                                  |
| 23.11.2025 | Микросервисы: паттерны проектирования     | API Gateway, Circuit Breaker, Saga, CQRS                                       |
| 24.11.2025 | Event-Driven архитектура                  | Event Sourcing, CQRS, шины событий                                             |
| 25.11.2025 | Hexagonal Architecture (Ports & Adapters) | Домен, порты, адаптеры, примеры                                                |
| 26.11.2025 | Clean Architecture в Python               | Entities, Use Cases, Interface Adapters                                        |
| 27.11.2025 | Паттерны проектирования GoF               | Singleton, Factory, Observer, Strategy и др.                                   |
| 28.11.2025 | SOLID принципы с примерами                | Каждый принцип с кодом и антипаттернами                                        |
| 29.11.2025 | KISS, YAGNI, DRY: практическое применение | Как не переусложнять код                                                       |
| 30.11.2025 | Docker: продвинутые техники               | Multi-stage, volumes, networks, compose                                        |
