+++
lang = "ru"
title = "Разворачивание n8n платформы на Docker Compose"
description = "Подробное руководство по развертыванию n8n workflow automation платформы с использованием Docker Compose: настройка, конфигурация, персистентность данных и продакшен развертывание."
template = "posts"
thumb = "/imgs/2025/08/n8n-docker-compose-deployment.png"
publication_date = "2025-08-14"
+++

# Разворачивание n8n платформы на Docker Compose
...
**💡 Быстрый старт:** Всю платформу n8n можно развернуть в один клик на хостинге [Timeweb Cloud](https://timeweb.cloud/), используя их готовые шаблоны развертывания. Это идеальное решение для тех, кто хочет быстро запустить n8n без настройки Docker.
