...
В исходной статье на Habr сравниваются два подхода: попросить AI сделать компонент по принципу «80/20» или проектировать системно вместе с агентом. Это хороший пример зрелого отношения к AI в frontend-разработке. Модель полезна, но без архитектурного контроля она легко генерирует красивый, но хрупкий UI.
