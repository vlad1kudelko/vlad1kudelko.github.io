...
В исходной статье на Habr разбирается, как считать честные RTO и RPO. Это важная тема: отказоустойчивость нельзя проектировать только ожиданиями бизнеса. Её нужно приземлять на физику инфраструктуры, скорость восстановления и регулярные учения.
