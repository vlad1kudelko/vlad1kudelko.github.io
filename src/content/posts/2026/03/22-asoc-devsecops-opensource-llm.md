...
В исходной статье на Habr автор описывает опыт создания ASOC-платформы с использованием Open Source и LLM. Идея интересна тем, что AppSec можно улучшать не только покупкой большого enterprise-продукта. Для части команд достаточно собрать собственный слой корреляции поверх уже существующих сканеров, CI/CD и таск-трекера.
