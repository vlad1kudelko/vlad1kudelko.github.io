...
В исходном материале на Habr рассматривается роль инвентаризации в SOAR, VM и CMDB. Это важная тема: современные security-инструменты зависят не только от своих алгоритмов, но и от качества данных об инфраструктуре.
