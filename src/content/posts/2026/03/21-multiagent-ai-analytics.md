...
В исходном кейсе на Habr команда за несколько дней собрала платформу для бизнес-аналитики, объединяющую BI и мультиагентный ИИ. Интересен не сам формат хакатона, а подход: они начали не с выбора модели, а с бизнес-проблемы — падение выручки, рост оттока клиентов и нехватка скорости принятия решений. Это правильная отправная точка для любых AI-систем.
