...
Geo-данные — сложная структура, требующая специальных подходов к хранению, индексации и запросам: стандартные реляционные БД оказываются беспомощными при реальных нагрузках.
...
Поиск всех кофеен в радиусе 500 метров — типичный геозапрос. На первый взгляд простой:
