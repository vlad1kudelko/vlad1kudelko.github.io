...
WebSocket-соединения сохраняют состояние — в отличие от HTTP-запросов. Это усложняет балансировку нагрузки, сохранение сессий и обработку обрывов. Архитектура на десятки подключений рушится под тысячами.
