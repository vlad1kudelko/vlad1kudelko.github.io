...
PostgreSQL или Elasticsearch для полнотекстового поиска — выбор с реальными последствиями. Многие проекты переплачивают за Elasticsearch там, где хватило бы встроенного поиска, или теряют в производительности, оставшись на PostgreSQL при большом объёме данных.
