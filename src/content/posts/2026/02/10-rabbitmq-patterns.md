...
RabbitMQ хорошо работает там, где нужна надёжная доставка и сложная маршрутизация. Для простых задач с минимальной задержкой прямая связь между сервисами дешевле. Главное — понимать exchange-типы и очереди до выхода в продакшен.