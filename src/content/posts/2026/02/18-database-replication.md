...
Ключевой аспект успешной репликации — требования к согласованности данных, которые диктует бизнес. Гибридная модель: master-slave для основной нагрузки и master-master для резервных зон с механизмом автоматического переключения при недоступности основного master.
