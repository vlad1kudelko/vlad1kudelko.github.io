...
Вертикальное масштабирование упирается в потолок — железо дорожает, а нагрузка растёт. Sharding распределяет данные по нескольким узлам, но добавляет архитектурную сложность: распределённые транзакции, кросс-шардовые запросы, ребалансировка.

## Архитектурный подход к горизонтальному масштабированию
...
Sharding снимает потолок масштабирования, но добавляет значительную сложность. Прежде чем идти туда — исчерпайте вертикальное масштабирование и репликацию.