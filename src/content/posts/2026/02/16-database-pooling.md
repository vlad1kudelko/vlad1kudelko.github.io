...
PgBouncer снижает нагрузку на PostgreSQL в высоконагруженных системах, но требует понимания ограничений: transaction mode ломает сессионные фичи, prepared statements нужно отключать.