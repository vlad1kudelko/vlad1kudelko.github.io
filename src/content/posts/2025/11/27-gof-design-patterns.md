...
Эти паттерны были описаны в книге 1994 года и стали фундаментом объектно-ориентированного проектирования. Знание паттернов помогает распознавать типовые проблемы и применять проверенные решения вместо изобретения велосипеда.
