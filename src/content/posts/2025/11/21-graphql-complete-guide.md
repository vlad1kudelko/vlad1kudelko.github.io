...
| Данные | Фиксированная структура | Гибкая структура |
| Версионирование | /api/v1/, /api/v2/ | Эволюция схемы |
| Кэширование | HTTP кэш | Требуется реализация |
| Документация | OpenAPI/Swagger | Introspection |
| Ошибки | HTTP статусы | Поле errors в ответе |
