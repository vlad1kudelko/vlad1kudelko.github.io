...
Нарушение контроля доступа позволяет пользователям получать несанкционированный доступ к данным и функциям. Это самая распространённая уязвимость по статистике OWASP.
