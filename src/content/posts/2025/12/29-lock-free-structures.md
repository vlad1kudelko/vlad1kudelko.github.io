---
title: "Lock-free структуры данных — атомарные операции и CAS"
description: "Изучите lock-free структуры: атомарные операции, CAS, memory ordering. Создавайте высокопроизводительные многопоточные приложения."
