...
Runes — это специальные символы (функции), которые сообщают компилятору Svelte о реактивных зависимостях. Основные runes: $state, $derived, $effect.

### $state

$state создаёт реактивную переменную. При изменении значения компонент автоматически перерисовывается.
