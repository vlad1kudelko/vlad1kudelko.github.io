...
| Тип | Подход | Когда использовать |
|-----|--------|-------------------|
| **Оптимистичный** | Разрешаем конфликты, обрабатываем ошибки | Конфликты редки |
| **Пессимистичный** | Блокируем на всякий случай (SELECT FOR UPDATE) | Конфликты часты |
