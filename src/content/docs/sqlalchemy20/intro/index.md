...
SQLAlchemy SQL Toolkit и Object Relational Mapper представляет собой комплексный набор инструментов для работы с базами данных в Python. Библиотека имеет несколько отдельных областей функциональности, которые можно использовать как по отдельности, так и вместе. Основные компоненты показаны ниже, с зависимостями, организованными по уровням:
