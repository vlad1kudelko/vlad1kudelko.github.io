...
Если ранее мы передавали словари Python для формирования INSERT, то при использовании ORM мы напрямую работаем с Python-классами, определёнными ранее в разделе **Using ORM Declarative Forms to Define Table Metadata**. На уровне классов User и Address мы определяли структуру таблиц. Эти же классы служат объектами-контейнерами данных, с помощью которых мы создаём и изменяем строки в транзакции.
